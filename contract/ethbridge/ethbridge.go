...
func (_EthBridge *EthBridgeCaller) BridgeState(opts *bind.CallOpts) (TopBridgeBridgeState, error) {
	var out []interface{}
...
//
// Solidity: function bridgeState() view returns((uint256,uint256,uint256) res)
func (_EthBridge *EthBridgeSession) BridgeState() (TopBridgeBridgeState, error) {
...
func (_EthBridge *EthBridgeTransactor) Initialize(opts *bind.TransactOpts, _lockEthAmount *big.Int, _owner common.Address) (*types.Transaction, error) {
	return _EthBridge.contract.Transact(opts, "initialize", _lockEthAmount, _owner)
}

// Initialize is a paid mutator transaction binding the contract method 0xda35a26f.
//
// Solidity: function initialize(uint256 _lockEthAmount, address _owner) returns()
func (_EthBridge *EthBridgeSession) Initialize(_lockEthAmount *big.Int, _owner common.Address) (*types.Transaction, error) {
	return _EthBridge.Contract.Initialize(&_EthBridge.TransactOpts, _lockEthAmount, _owner)
}

// Initialize is a paid mutator transaction binding the contract method 0xda35a26f.
//
// Solidity: function initialize(uint256 _lockEthAmount, address _owner) returns()
func (_EthBridge *EthBridgeTransactorSession) Initialize(_lockEthAmount *big.Int, _owner common.Address) (*types.Transaction, error) {
	return _EthBridge.Contract.Initialize(&_EthBridge.TransactOpts, _lockEthAmount, _owner)
}
